...
description: 检测并映射建筑组织中的数据孤岛。识别断开的数据源和集成机会
tags:
- 数据
- 建筑
---
...
基于DDC方法论（第1.2章），本技能检测并映射建筑组织中的数据孤岛，识别断开的数据源、重复数据以及集成机会。

**书籍参考：** "Технологии и системы управления в современном строительстве" / "Technologies and Management Systems in Modern Construction"
...
- 使用 [etl-pipeline](../../Chapter-4.2/etl-pipeline/SKILL.md) 连接孤岛
