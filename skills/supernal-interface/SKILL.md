...
description: 通用AI接口框架，使应用程序可被AI控制。适用于添加AI工具装饰器、设置聊天适配器、创建AI可调用的函数或集成CopilotKit。
---
...
Decorate functions → AI 可以 call them with full type safety.
...
AI assistants 可以 now discover and call your decorated functions.
...
- Auto 测试 generation from decorators
