...
description: 使用 DDC CWICR 基于资源的方法计算建筑成本。将成本分解为人工、材料、设备，并提供透明的定价。
...
### Problem Statement
传统的成本估算通常产生带有隐藏加价的"黑箱"估算。利益相关者需要：
- 透明的成本分解
- 可追溯的定价逻辑
- 可审计的计算
- 资源级别的细节
...
### Solution
使用 CWICR 方法的基于资源的成本计算，将物理定额（人工小时、材料数量）与波动的价格分开，从而实现透明且可审计的估算。

### Business Value
- **完全透明** - 每个成本组件可见
- **可审计** - 可追溯的计算逻辑
- **灵活** - 更新价格而不改变定额
- **准确** - 基于 55,000+ 已验证的工作项
